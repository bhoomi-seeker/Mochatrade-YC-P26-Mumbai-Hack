import { PathNode, PathEdge, Transaction, RiskFactor, RiskLevel } from '../models/types';

export class RiskEngine {
  public static calculatePathRisk(params: {
    nodes: PathNode[];
    edges: PathEdge[];
    transactions: Transaction[];
    hasFraudIncident: boolean;
    fanOutCount: number;
    fanInCount: number;
    hasCircularFlow: boolean;
    totalPropagationMinutes: number;
  }): {
    score: number;
    level: RiskLevel;
