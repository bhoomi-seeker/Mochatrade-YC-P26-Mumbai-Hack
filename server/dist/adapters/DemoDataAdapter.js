...
class DemoDataAdapter {
    adapterName = 'DemoDataAdapter (Synthetic Zero-Cost Indian Banking Dataset)';
    isLiveFeed = false;
    transactions = new Map();
    accounts = new Map();
    upiEntities = new Map();
    beneficiaries = new Map();
    fraudIncidents = new Map();
    ...
    generateDataset() {
        ...
        for (let i = 1; i <= 15; i++) {
            ...
            const risk = i === 9 ? 'CRITICAL' : i % 4 === 0 ? 'HIGH' : i % 2 === 0 ? 'MEDIUM' : 'LOW';
    ...
    async getFraudIncidentById(incidentId) {
